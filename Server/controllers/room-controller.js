...
module.exports.joinRoom = async(req, res) => {
    ...
    try
    {
        ...
        await desiredRoom.populate("Player1", ["username", "profileImage" ,"trophies", "gamesWon", "gamesLost"]).populate("Player2", ["username", "profileImage","trophies", "gamesWon", "gamesLost"]).execPopulate();
